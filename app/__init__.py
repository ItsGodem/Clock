...
class MainApp(App):
    ...
    color_primary_s = ColorProperty(rgba("#02589A"))
    color_primary_f = ColorProperty(rgba("#1F86E1"))
    ...
    red = ColorProperty(rgba("#D32F2F"))
    blue = ColorProperty(rgba("#5C6BC0"))
    green = ColorProperty(rgba("#4CAF50"))
    yellow = ColorProperty(rgba("#FFD54F"))
    fonts = QueryDict()
